...
def get_dataset(imgs_folder, isTrain = True):
    ...
    ds = ImageFolder(imgs_folder, data_transform)
    class_num = ds[-1][1] + 1
    return ds, class_num

def get_train_loader(conf):
    # modify
    ds, class_num = get_dataset(conf.calfw_folder/'train')
...
def get_val_data(conf):
    # modify
    ds, class_num = get_dataset(conf.calfw_folder/'val', isTrain=False)
